...
| 路线图 | `docs/next_steps_plan.md`、`docs/product_roadmap.md` |
...
│   ├── tasks/                      # 🆕 任务包（输入）
│   │   ├── README.md               # 任务包索引（看板）
│   │   ├── sup_a_flixpatrol_accessibility.md
│   │   ├── sup_b_*.md
│   │   └── ...
│   │
...
## 🟢 Ready（可拾取）
- [SUP-A FlixPatrol 可访问性](sup_a_flixpatrol_accessibility.md)
- [SUP-D FlixPatrol 合规评估](sup_d_compliance.md)（待创建）
...
## ✅ Completed（最近 5 个）
- [Phase 0 收尾](completed/phase0_cleanup_2026-05-10.md)
- [Entity Matching 4 case 修复](completed/entity_matching_v2_2026-05-09.md)
