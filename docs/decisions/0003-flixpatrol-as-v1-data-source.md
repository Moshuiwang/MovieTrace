...
**状态：** ✅ Accepted（核心决策仍有效；实施方式由 ADR-0006 切换为 API 路径）  
**日期：** 2026-05-10  
**决策者：** 用户 + Claude Code (Haiku 4.5 / Sonnet 4.6)  
**相关 Commit：** `b584e94`（提出）/ `7e492e8`（验证通过）/ `81f6f25`（SUP-G API 验证）
...
如果 SUP-A/B/C/D/E 任一不通过，**降级到备选 C**（仅 TMDb / Trakt / OMDb），V1 范围相应缩减，但产品上线进度不变。详见 [`docs/phase0_supplement.md`](../reference/phase0_supplement.md) § 6（备选方案）。
...
- 验证计划：[`docs/phase0_supplement.md`](../reference/phase0_supplement.md)
